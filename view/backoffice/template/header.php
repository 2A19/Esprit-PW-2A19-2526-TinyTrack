...
<nav class="main-header navbar navbar-expand navbar-white navbar-light">
  <ul class="navbar-nav">
    ...
    <li class="nav-item d-none d-sm-inline-block"><a href="/ProjetRapport/view/backoffice/listRapports.php" class="nav-link" style="font-family:'Fredoka One',cursive;color:var(--tt-green);"><i class="fas fa-home"></i> Dashboard</a></li>
  </ul>
