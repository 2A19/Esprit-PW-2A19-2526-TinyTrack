<?php
// Vue passive — données injectées par RapportController::parent()
// Variables : $rapports
        ...
        <div class="col-md-6 col-lg-4">
          <div class="card-kider p-4">
            ...
            <div class="medical-box">
              ...
              <p class="mb-2"><i class="fas fa-user-tie" style="color:var(--kider-green);"></i> <strong>Éducateur ID :</strong> <?= $r['id_educateur'] ?? '—' ?></p>
            </div>
            <div class="mt-3 text-center">
              <a href="/TinyTrack/rapports/pdf/<?= (int)$r['id_rapport'] ?>" target="_blank" class="btn btn-danger btn-sm" style="border-radius:25px;padding:0.45rem 1.2rem;">
