<?php
// Vue passive — données injectées par EvenementController::frontofficeReservationsParent()
...
<div class="container py-5" style="position:relative;z-index:1;">
  ...
  <div class="text-center mt-4">
    <a href="/TinyTrack/evenements/parent" class="btn btn-success" style="border-radius:25px;padding:0.5rem 1.5rem;font-weight:700;"><i class="fas fa-arrow-left"></i> Retour aux événements</a>
  </div>
</div>
