<?php
// Vue passive — données injectées par EducateurController::monProfil()
// Variables : $profil, $groupe, $enfants, $parentsContacts, $rapports, $errors, $success
$educateur = $profil;
      ...
      <div class="card-kider p-0" style="overflow:hidden;">
        ...
        <div style="background:linear-gradient(135deg,#5B9BD5,#90CAF9);padding:2rem;text-align:center;position:relative;">
          ...
          <div style="margin-top:0.8rem;">
            <?php if (!$editMode): ?>
              <a href="/TinyTrack/educateurs/profil?edit=1" style="background:rgba(255,255,255,0.25);color:#fff;padding:0.4rem 1.2rem;border-radius:20px;font-size:0.8rem;font-weight:700;text-decoration:none;"><i class="fas fa-edit"></i> Modifier mon profil</a>
            <?php else: ?>
              <a href="/TinyTrack/educateurs/profil" style="background:rgba(255,255,255,0.25);color:#fff;padding:0.4rem 1.2rem;border-radius:20px;font-size:0.8rem;font-weight:700;text-decoration:none;"><i class="fas fa-times"></i> Annuler</a>
            <?php endif; ?>
          </div>
        </div>
