<?php
// Vue passive — données injectées par AuthController::showRegister() / doRegister()
// Variables disponibles : $activeTab, $errors, $success, $old
?>
<!DOCTYPE html>
<html lang="fr">
<head>
...
<div class="reg-card">
  ...
  <?php if ($success): ?>
    <div class="success-box">
      ...
      <a href="/TinyTrack/login" class="btn-go-login"><i class="fas fa-sign-in-alt"></i> Retour au login</a>
    </div>
  <?php else: ?>
    ...
    <div class="reg-panel <?= $activeTab === 'educateur' ? 'active' : '' ?>" id="rpanel-educateur">
      <form method="POST" action="/TinyTrack/register" novalidate onsubmit="return validerForm()">
  ...
  <div class="card-footer-r">Déjà un compte ? <a href="/TinyTrack/login">Se connecter</a></div>
</div>
