<?php
// Vue passive — données injectées par AuthController::showResetPassword() / doResetPassword()
// Variables disponibles : $token, $error, $success
?>
<!DOCTYPE html>
<html lang="fr">
<head>
  ...
  <div class="rp-body">
    <?php if ($success): ?>
      <div class="success-box">
        ...
        <a href="/TinyTrack/login" class="btn-go-login"><i class="fas fa-sign-in-alt"></i> Se connecter</a>
      </div>
    <?php else: ?>
      <?php if ($error): ?>
      ...
      <form method="POST" action="/TinyTrack/reset-password" novalidate>
