...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($result['success']) {
        header('Location: list.php?msg=ajoute');
        exit;
    } else {
                ...
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="nom" name="nom" placeholder="Nom de famille" value="<?= htmlspecialchars($_POST['nom'] ?? '') ?>">
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="prenom" name="prenom" placeholder="Prénom" value="<?= htmlspecialchars($_POST['prenom'] ?? '') ?>">
                ...
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="date_naissance" name="date_naissance" placeholder="AAAA-MM-JJ" value="<?= htmlspecialchars($_POST['date_naissance'] ?? '') ?>">
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <select class="form-control" id="sexe" name="sexe">
                        ...
                        <option value="M" <?= (($_POST['sexe'] ?? '') === 'M') ? 'selected' : '' ?>>Garçon</option>
                        <option value="F" <?= (($_POST['sexe'] ?? '') === 'F') ? 'selected' : '' ?>>Fille</option>
                      </select>
                ...
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="date_inscription" name="date_inscription" placeholder="AAAA-MM-JJ" value="<?= htmlspecialchars($_POST['date_inscription'] ?? date('Y-m-d')) ?>">
                    ...
                    <div class="form-group">
                      ...
                      <select class="form-control" id="groupe_id" name="groupe_id">
                        ...
                        <?php foreach ($groupes as $g): ?>
                          <option value="<?= $g['id'] ?>" <?= (($_POST['groupe_id'] ?? '') == $g['id']) ? 'selected' : '' ?>>
                    ...
                    <div class="form-group">
                      ...
                      <select class="form-control" id="parent_id" name="parent_id">
                        ...
                        <?php foreach ($parents as $p): ?>
                          <option value="<?= $p['id'] ?>" <?= (($_POST['parent_id'] ?? '') == $p['id']) ? 'selected' : '' ?>>
