<?php
// Vue passive — données injectées par ReservationController::index()
// Variables : $reservations, $flash
      ...
      <div class="card card-info">
        <div class="card-header">
          <div class="row align-items-center">
            ...
            <div class="col-md-4 text-right"><a href="/TinyTrack/reservations/add" class="btn btn-success"><i class="fas fa-plus-circle"></i> Ajouter</a></div>
          </div>
        </div>
        <div class="card-body">
              ...
              <?php else: ?>
                ...
                <tr>
                  ...
                  <td>
                    ...
                    <form method="POST" action="/TinyTrack/reservations/delete/<?= (int)$r['id'] ?>" style="display:inline" onsubmit="return confirm('Supprimer ?')">
