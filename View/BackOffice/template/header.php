...
<nav class="main-header navbar navbar-expand navbar-white navbar-light">
  <ul class="navbar-nav">
    ...
    <li class="nav-item d-none d-sm-inline-block">
      <a href="/TinyTrack/View/BackOffice/enfants/list.php" class="nav-link" style="font-family:'Fredoka One',cursive; color:var(--tt-green);">
  ...
  <ul class="navbar-nav ml-auto">
    <li class="nav-item">
      <span class="nav-link" style="font-weight:700;"><i class="fas fa-user-shield text-success"></i> Administrateur</span>
    </li>
    <li class="nav-item">
      <a class="nav-link" href="/TinyTrack/View/auth/logout.php" style="color:#dc3545; font-weight:700;" onclick="return confirm('Se déconnecter ?')">
