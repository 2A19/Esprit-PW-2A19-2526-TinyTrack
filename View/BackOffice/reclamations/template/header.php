...
<head>
  ...
  <title>TinyTrack — Gestion des Réclamations</title>
  ...
  <style>
    :root{--tt-green:#4CAF50;--tt-blue:#5B9BD5;--tt-yellow:#FFD93D;--tt-pink:#FF8FAB;--tt-orange:#FFA726;--tt-purple:#9C7CDB;--tt-bg:#F0F7FF}
    ...
    .card{border:none;border-radius:20px;box-shadow:0 4px 20px rgba(0,0,0,0.05);overflow:hidden;transition:transform 0.2s}
    ...
    .badge{border-radius:20px;padding:0.35rem 0.8rem;font-weight:700}
...
<nav class="main-header navbar navbar-expand navbar-white navbar-light">
  <ul class="navbar-nav">
    ...
    <li class="nav-item d-none d-sm-inline-block"><a href="/TinyTrack/View/BackOffice/reclamations/reclamationBack.php" class="nav-link" style="font-family:'Fredoka One',cursive;color:var(--tt-green);"><i class="fas fa-home"></i> Dashboard</a></li>
  </ul>
