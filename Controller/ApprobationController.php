...
class ApprobationController extends Controller {
    ...
    public function index(): void {
        $this->requireAuth();
        $this->render('FrontOffice/approbation', [
            'enAttente' => $this->listerEnAttente(),
            'actifs'    => $this->listerActifs(),
        ]);
    }

    // POST /approbation/approuver/{id}
    public function approuverAction($id): void {
        $this->requireAuth();
        $this->approuver($id);
        $this->redirect('/approbation');
    }

    // POST /approbation/rejeter/{id}
    public function rejeterAction($id): void {
        $this->requireAuth();
        $this->rejeter($id);
        $this->redirect('/approbation');
    }
