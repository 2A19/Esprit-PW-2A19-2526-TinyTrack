...
require_once __DIR__ . "/../Model/MessageAmen.php";
...
class MessageController {
    ...
    public function store() {
        ...
        $message_id = $this->model->create($conversation_id, $sender_id, $sender_role, $body);
            ...
            if ($response) {
                ...
                if (isset($responseData['choices'][0]['message']['content'])) {
                    ...
                    if (!empty($botReply)) {
                        ...
                        $bot_message_id = $this->model->create($conversation_id, 1, 'admin', '🤖 Bot: ' . $botReply);
                        $botReplyText = '🤖 Bot: ' . $botReply;
                    }
                }
            }
        }
